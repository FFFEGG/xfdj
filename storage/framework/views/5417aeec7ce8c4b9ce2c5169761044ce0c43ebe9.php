        ...
        <form class="am-form" id="form" action="/register_gys" method="POST" enctype="multipart/form-data">
            ...
            <fieldset class="upload_form">
                <div class="am-form-group">
                    ...
                    <input name="username" value="<?php echo e(old('username'), false); ?>" type="text" class="" id="doc-ipt-email-1"
                           placeholder="登录账号">
                </div>
                <div class="am-form-group">
                    <label for="doc-ipt-email-2">登录密码</label>
                    <input name="password" value="<?php echo e(old('password'), false); ?>" type="password" class="" id="doc-ipt-email-2"
                           placeholder="设置个密码吧">
                </div>
                <div class="am-form-group">
                    <label for="doc-ipt-email-2">确认密码</label>
                    <input name="password_confirmation" value="<?php echo e(old('password_confirmation'), false); ?>" type="password"
                           class="" id="doc-ipt-email-2" placeholder="输确认密码">
                </div>
                <div class="am-form-group">
                    <label for="doc-ipt-email-1">公司名称</label>
                    <input name="name" value="<?php echo e(old('name'), false); ?>" type="text" class="" id="doc-ipt-email-3"
                           placeholder="输入公司名称">
                </div>
                <div class="am-form-group">
                    <label for="doc-ipt-email-3">联系人电话</label>
                    <input name="tel" value="<?php echo e(old('tel'), false); ?>" type="text" class="" maxlength="11" minlength="11"
                           id="doc-ipt-email-4" placeholder="联系人电话">
                </div>
                <div class="am-form-group">
                    <label for="doc-select-1">供应商分类</label>
                    <select id="doc-select-1" name="type" value="<?php echo e(old('type'), false); ?>">
                ...
                <div class="am-form-group am-form-file">
                    ...
                    <input name="file[]" value="<?php echo e(old('file'), false); ?>" id="doc-form-file" type="file" multiple>
                </div>
                ...
                <div class="am-form-group am-form-file" style="clear: both;float: left;margin-right: 20px">
                    ...
                    <input name="hyzz[]" value="<?php echo e(old('hyzz'), false); ?>" id="doc-form-files" type="file">
                </div>
...
<?php /**PATH /www/wwwroot/xfdj/resources/views/supplier/register.blade.php ENDPATH**/ ?>