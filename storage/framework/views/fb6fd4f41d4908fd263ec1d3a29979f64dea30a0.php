                    ...
                    <div class="widget-body am-fr">
                        ...
                        <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input value="<?php echo e($goods->title, false); ?>" type="text" name="title" class="tpl-form-input"
                                ...
                                <div class="am-u-sm-9">
                                    <select name="type" data-am-selected="{searchBox: 1}" style="display: none;">
                                        <?php $__currentLoopData = $goodstype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php if($goods->type == $v->id): ?> selected <?php endif; ?> value="<?php echo e($v->id, false); ?>"><?php echo e($v->name, false); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="am-u-sm-9">
                                    <select name="cgy" data-am-selected="{searchBox: 1}" style="display: none;">
                                        <?php $__currentLoopData = \App\Cgy::get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php if($goods->cgy == $v->id): ?> selected <?php endif; ?> value="<?php echo e($v->id, false); ?>"><?php echo e($v->name, false); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <div class="am-form-group am-form-file">
                                        ...
                                        <input name="file[]" value="<?php echo e($goods->file, false); ?>" id="doc-form-file" type="file" multiple="">
...
<?php echo $__env->make('supplier.common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/xfdj/resources/views/supplier/edit.blade.php ENDPATH**/ ?>