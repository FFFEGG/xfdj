...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('/vendor/horizon/img/favicon.png'), false); ?>">

    <title>Horizon</title>

    <!-- Style sheets-->
    <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">
    <link href="<?php echo e(asset(mix($cssFile, 'vendor/horizon')), false); ?>" rel="stylesheet" type="text/css">
</head>
<body>
...
<script src="<?php echo e(asset(mix('app.js', 'vendor/horizon')), false); ?>"></script>
</body>
</html>
<?php /**PATH /www/wwwroot/xfdj/vendor/laravel/horizon/src/../resources/views/layout.blade.php ENDPATH**/ ?>