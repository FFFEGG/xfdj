                    ...
                    <div class="widget-body am-fr">
                        ...
                        <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input value="{{ $goods->title }}" type="text" name="title" class="tpl-form-input"
                                ...
                                <div class="am-u-sm-9">
                                    <select name="type" data-am-selected="{searchBox: 1}" style="display: none;">
                                        @foreach($goodstype as $v)
                                            <option @if($goods->type == $v->id) selected @endif value="{{ $v->id }}">{{ $v->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="am-u-sm-9">
                                    <select name="cgy" data-am-selected="{searchBox: 1}" style="display: none;">
                                        @foreach(\App\Cgy::get() as $v)
                                            <option @if($goods->cgy == $v->id) selected @endif value="{{ $v->id }}">{{ $v->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <div class="am-form-group am-form-file">
                                        ...
                                        <input name="file[]" value="{{ $goods->file }}" id="doc-form-file" type="file" multiple="">
