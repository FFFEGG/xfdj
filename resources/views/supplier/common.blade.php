...
{{--            <li class="sidebar-nav-heading">Components <span class="sidebar-nav-heading-info"> 附加组件</span></li>--}}
            ...
            <li class="sidebar-nav-link">
                <a href="/supplier/orders" @if($active==2)class="active"@endif>
                    <i class="am-icon-table sidebar-nav-link-logo"></i> 订单管理
                </a>
            </li>
            <li class="sidebar-nav-link">
                <a href="/supplier/goodslist" @if($active==3)class="active"@endif>
                    <i class="am-icon-calendar sidebar-nav-link-logo"></i> 产品列表
                </a>
            </li>
            <li class="sidebar-nav-link">
                <a href="/supplier/goodsuploads" @if($active==4)class="active"@endif>
