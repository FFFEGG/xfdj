...
class CouponCodesController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->text('desc', '说明')->rules('required')->help('不要超过8个汉字');
        ...
        })->help('获取随机码：<a target="_blank" href="http://coolaf.com/tool/rd">点击获取</a>')
        ->default(CouponCode::findAvailableCode());
        ...
        $form->switch('is_active', '首页展示')->options(['1' => '是', '0' => '否']);
