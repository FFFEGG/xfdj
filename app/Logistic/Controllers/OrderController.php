...
use App\Logistic\Actions\Ps\Hbdy;
...
class OrderController extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid->column('psdanhap','配送单号')->display(function ($v){
            return PsList::whereOrderId($this->id)->first()?PsList::whereOrderId($this->id)->first()->logps->id:'';
        })->label();
        ...
        $grid->column('group_address','取货点地址')->display(function ($v){
            return Group::find($this->group_id)->address;
        })->label();
